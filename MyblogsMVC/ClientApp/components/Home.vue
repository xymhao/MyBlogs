<template>
    <div>
        ...
        <p>如何快速搭建.Net Core + Vue + TypeScript SPA页面</p>

        <ul>
            <li>进入我的demo工作目录: D:\SPA</li>
            <li>按住Shift, 在右键菜单中点击 “在此处打开powershell窗口”</li>
            <li>使用以下命令创建:</li>
            <li>cd D\SPA</li>
            <li>dotnet new --install Microsoft.AspNetCore.SpaTemplates::*</li>
            <li>dotnet new vue -n SpaWeb</li>
            <li>cd SpaWeb</li>
            <li>npm install</li>
            <li>dotnet run</li>
        </ul>
